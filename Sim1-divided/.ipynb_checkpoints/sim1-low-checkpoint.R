...
library(parallel)
library(furrr)
write("", "sim1-keele-low.txt", append = FALSE)   ##### ADDED (overwrite existing file)
...
filename <- paste0("simulation-1-keele-", sim_reps, "-low", ".RData")
