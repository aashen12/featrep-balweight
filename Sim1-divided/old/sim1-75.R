...
library(parallel)
library(furrr)
write("", "sim1-keele-overlap75.txt", append = FALSE)   ##### ADDED (overwrite existing file)
...
filename <- paste0("simulation-1-keele-", sim_reps, "-overlap75", ".RData")
