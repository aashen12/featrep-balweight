# generate Luke's data from Simulation 2 from Bal-Wgt-Educ
library(MASS)
library(tidyverse)
...
out_filename <- paste0("sim2-keele-", overlap_degree, ".txt")
...
filename <- paste0("results/simulation-2-keele-", sim_reps, "-", overlap_degree, ".RData")
