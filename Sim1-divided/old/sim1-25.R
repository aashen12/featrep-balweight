...
library(parallel)
library(furrr)
write("", "sim1-keele-overlap25.txt", append = FALSE)   ##### ADDED (overwrite existing file)
...
filename <- paste0("simulation-1-keele-", sim_reps, "-overlap25", ".RData")
